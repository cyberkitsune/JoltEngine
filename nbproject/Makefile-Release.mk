...
${OBJECTDIR}/src/JoltRender.o: src/JoltRender.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/JoltRender.o src/JoltRender.cpp

${OBJECTDIR}/src/JoltLoop.o: src/JoltLoop.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/JoltLoop.o src/JoltLoop.cpp

${OBJECTDIR}/src/JoltCleanup.o: src/JoltCleanup.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/JoltCleanup.o src/JoltCleanup.cpp
...
${OBJECTDIR}/src/JoltDataFile.o: src/JoltDataFile.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/JoltDataFile.o src/JoltDataFile.cpp

${OBJECTDIR}/src/JoltApp.o: src/JoltApp.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/JoltApp.o src/JoltApp.cpp

${OBJECTDIR}/src/JoltInit.o: src/JoltInit.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/JoltInit.o src/JoltInit.cpp
...
${OBJECTDIR}/src/JoltEntityCol.o: src/JoltEntityCol.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/JoltEntityCol.o src/JoltEntityCol.cpp
...
${OBJECTDIR}/src/JoltZone.o: src/JoltZone.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/JoltZone.o src/JoltZone.cpp

${OBJECTDIR}/src/JoltEvent.o: src/JoltEvent.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/JoltEvent.o src/JoltEvent.cpp

${OBJECTDIR}/src/JoltConsole.o: src/JoltConsole.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/JoltConsole.o src/JoltConsole.cpp

${OBJECTDIR}/src/JoltEntity.o: src/JoltEntity.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/JoltEntity.o src/JoltEntity.cpp
