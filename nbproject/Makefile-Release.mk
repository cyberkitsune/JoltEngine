...
${OBJECTDIR}/DrawMacros.o: DrawMacros.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/DrawMacros.o DrawMacros.cpp

${OBJECTDIR}/JoltApp.o: JoltApp.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/JoltApp.o JoltApp.cpp

${OBJECTDIR}/JoltAnimation.o: JoltAnimation.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/JoltAnimation.o JoltAnimation.cpp

${OBJECTDIR}/JoltEvent.o: JoltEvent.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/JoltEvent.o JoltEvent.cpp
...
${OBJECTDIR}/JoltConsole.o: JoltConsole.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/JoltConsole.o JoltConsole.cpp

${OBJECTDIR}/JoltCleanup.o: JoltCleanup.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/JoltCleanup.o JoltCleanup.cpp

${OBJECTDIR}/JoltEntity.o: JoltEntity.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/JoltEntity.o JoltEntity.cpp
